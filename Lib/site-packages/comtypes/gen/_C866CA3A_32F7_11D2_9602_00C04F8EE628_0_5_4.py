...
__all__ = [
    'DISPID_SWFEBlockAlign', 'SPAR_Unknown', 'DISPID_SVPriority',
    'ISpeechPhraseInfoBuilder', 'SPGRAMMARWORDTYPE',
    'SAFT44kHz16BitMono', 'SVEAudioLevel',
    'DISPID_SABIMinNotification', 'SVSFlagsAsync', 'SGRSTTEpsilon',
    'SpeechInterference', 'DISPID_SPAsCount', 'SPPS_RESERVED1',
    'SVP_1', 'SPCT_DICTATION', 'DISPID_SRCEEnginePrivate',
    'SAFT22kHz16BitMono', 'SRERequestUI', 'DISPID_SABufferInfo',
    'ISpResourceManager', 'DISPID_SDKSetStringValue',
    'DISPID_SPEActualConfidence', 'eLEXTYPE_PRIVATE8',
    'DISPID_SVGetProfiles', 'SAFTExtendedAudioFormat',
    'ISpeechPhraseReplacements', 'SAFT32kHz8BitMono', 'SPSLMA',
    'ISpeechGrammarRuleState', 'DISPID_SPPFirstElement',
    'DISPID_SpeechPhraseElements', 'SVP_16',
    'DISPID_SRCVoicePurgeEvent', 'DISPID_SVEStreamStart',
    'ISpNotifySource', 'DISPID_SVSVisemeId', 'SVP_11',
    'DISPID_SPPParent', 'DISPID_SRCCmdMaxAlternates',
    'SpeechTokenKeyUI', 'SAFTADPCM_11kHzMono', 'DISPID_SVVoice',
    'SPAR_Low', 'SPAS_RUN', 'SP_VISEME_5', 'SpeechMicTraining',
    'ISpeechObjectToken', 'SPSMF_UPS', 'SpeechAudioProperties',
    'DISPID_SVVolume', 'SpeechAudioFormatType',
    'SAFTCCITT_ALaw_11kHzMono', 'DISPID_SpeechObjectTokens',
    'DISPID_SPIGetText', 'DISPID_SPCLangId', 'DISPID_SGRAddResource',
    'DISPID_SPAPhraseInfo', 'SPAS_PAUSE',
    'DISPID_SRCAudioInInterferenceStatus', 'DISPID_SABIBufferSize',
    'DISPID_SRGRules', 'SRAInterpreter', 'DISPID_SOTGetAttribute',
    'SVP_8', 'DISPID_SPIAudioSizeTime',
    'DISPID_SVSCurrentStreamNumber', 'SPEI_MAX_TTS', 'SP_VISEME_11',
    'SAFT8kHz16BitMono', 'DISPID_SVSRunningState',
    'SECFEmulateResult', 'ISpProperties', 'ISpeechRecoResultDispatch',
    'SpMMAudioIn', '_ISpeechRecoContextEvents',
    'SPEI_RECO_OTHER_CONTEXT', 'SAFT12kHz8BitMono',
    'DISPID_SOTMatchesAttributes', 'SPEI_SR_BOOKMARK',
    'SpeechPropertyLowConfidenceThreshold',
    'DISPID_SpeechAudioFormat', 'DISPID_SVSLastBookmark',
    'DISPID_SPRulesCount', 'DISPID_SLRemovePronunciation', 'SPPS_LMA',
    'SPEI_PROPERTY_STRING_CHANGE', 'SPVISEMES', 'SPPS_NotOverriden',
    'SVP_21', 'SRARoot', 'DISPID_SGRSAddWordTransition',
    'DISPID_SLWLangId', 'SPEI_RESERVED1', 'SPEI_TTS_AUDIO_LEVEL',
    'SPPS_Noncontent', 'SPBO_TIME_UNITS', 'DISPID_SRAudioInput',
    'SP_VISEME_8', 'ISpeechPhraseElement', 'SAFTADPCM_8kHzStereo',
    'SPVPRI_OVER', 'SAFT16kHz8BitStereo', 'SpeechLexiconType',
    'ISpeechPhraseInfo', 'SAFTCCITT_uLaw_11kHzMono',
    'SPXRO_Alternates_SML', 'DISPID_SRSCurrentStreamNumber',
    'DISPID_SRGId', 'SREStreamEnd', 'DISPID_SpeechPhraseReplacement',
    'ISpShortcut', 'DISPID_SpeechPhraseElement', 'DISPID_SVEWord',
    'DISPID_SVDisplayUI', 'ISpeechPhraseRule', 'SPRECOCONTEXTSTATUS',
    '__MIDL___MIDL_itf_sapi_0000_0020_0001', 'SPEI_END_INPUT_STREAM',
    'SPSHT_Unknown', 'ISpeechLexiconPronunciation', 'SVP_10',
    'SPXMLRESULTOPTIONS', 'SPAS_STOP', 'DISPID_SVResume',
    'STCInprocHandler', 'SGSExclusive', 'eLEXTYPE_PRIVATE20',
    'SPINTERFERENCE', 'DISPID_SRRDiscardResultInfo',
    'DISPID_SOTRemoveStorageFileName', 'ISpLexicon',
    'SpeechTokenContext', 'eWORDTYPE_DELETED',
    'SpeechRecognitionType', 'SREStateChange',
    'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN', 'STSF_LocalAppData',
    'SP_VISEME_17', 'SPGS_DISABLED', 'SPEI_PHONEME',
    'SAFT48kHz16BitStereo', 'DISPID_SOTsCount', 'SSTTDictation',
    'SWTDeleted', 'SPRECORESULTTIMES', 'DISPID_SPEAudioTimeOffset',
    'DISPID_SVEVoiceChange', 'DISPID_SRRTTickCount',
    'SPEI_PROPERTY_NUM_CHANGE', 'SPBO_NONE', 'SPRST_INACTIVE',
    'DISPID_SRGCommit', 'SPWORDPRONOUNCEABLE', 'SRTEmulated',
    'DISPID_SRCRetainedAudioFormat', 'DISPID_SPRuleEngineConfidence',
    'ISpEventSink', 'DISPID_SPIRule', 'SAFTCCITT_ALaw_44kHzStereo',
    'ISpeechRecoResultTimes', 'SPEVENTENUM', 'SVSFParseSapi',
    'SVP_13', 'SVP_17', 'DISPID_SPRuleId', 'SPWF_INPUT',
    'DISPID_SRCEInterference', 'ISpPhrase', 'SPWORDPRONUNCIATIONLIST',
    'SITooLoud', 'SPCT_SLEEP', 'DISPID_SGRSTPropertyValue',
    'DISPID_SDKSetBinaryValue', 'eLEXTYPE_PRIVATE12', 'SSFMCreate',
    'DISPID_SAFGetWaveFormatEx', 'SDTReplacement', 'ISpNotifySink',
    'DISPID_SGRSAddSpecialTransition', 'DISPIDSPTSI_SelectionLength',
    'DISPID_SRGCmdSetRuleIdState', 'DISPID_SRProfile',
    'DISPID_SGRSRule', 'SAFT8kHz16BitStereo',
    'SAFTCCITT_ALaw_8kHzMono', 'SPLOADOPTIONS',
    'DISPID_SPEDisplayAttributes', 'DISPID_SRRTStreamTime',
    'SP_VISEME_18', 'DISPID_SVEPhoneme', 'SSSPTRelativeToStart',
    'SAFT22kHz8BitMono', 'ISpRecoContext2', 'DISPID_SASNonBlockingIO',
    'DISPID_SpeechCustomStream', 'DISPID_SpeechRecoContextEvents',
    'DISPID_SpeechPhraseInfo', 'SPBO_AHEAD', 'SAFT16kHz16BitStereo',
    'DISPID_SRGDictationSetState', 'DISPID_SGRSTransitions',
    'SPCT_SUB_DICTATION', 'SVF_None', 'ISpeechXMLRecoResult',
    '__MIDL_IWinTypes_0009', 'SREPrivate', 'ISpDataKey',
    'DISPID_SPISaveToMemory', 'SVEEndInputStream',
    'SAFT11kHz16BitStereo', 'DISPID_SGRSTsItem', 'DISPID_SpeechVoice',
    'SAFT12kHz16BitStereo', 'DISPID_SPRuleChildren',
    'DISPID_SRRAlternates', 'DISPID_SRDisplayUI',
    ...
    'DISPID_SRCESoundEnd', 'DISPID_SRCERecognition', 'SVEPhoneme',
    'DISPID_SPRuleName', 'DISPID_SPEDisplayText', 'SVPOver',
    'SGDSInactive', 'SpeechVoicePriority', 'SPAR_Medium',
    'ISpeechPhraseProperty', 'SAFTADPCM_44kHzStereo',
    'DISPID_SGRAddState', 'DISPID_SPAStartElementInResult',
    'SSTTWildcard', 'SPSInterjection', 'DISPID_SRCEStartStream',
    'LONG_PTR', 'SAFTCCITT_ALaw_11kHzStereo',
    'IInternetSecurityMgrSite', 'SPEI_PHRASE_START', 'SVPNormal',
    'SWTAdded', 'SpeechFormatType', 'SAFTADPCM_8kHzMono',
    'SWPKnownWordPronounceable', 'eLEXTYPE_PRIVATE14',
    'SPCT_SUB_COMMAND', 'DISPID_SVSLastBookmarkId',
    'SPINTERFERENCE_TOOFAST', 'DISPID_SLAddPronunciationByPhoneIds',
    'DISPID_SPRsCount', 'SpeechTokenIdUserLexicon',
    'ISpeechPhraseRules', 'ISpVoice', 'DISPID_SpeechPhraseAlternates',
    'SRESoundStart', 'DISPID_SRCESoundStart',
    'DISPID_SRRGetXMLResult', 'SPINTERFERENCE_TOOSLOW',
    'DISPID_SPILanguageId', 'SpResourceManager', 'SpShortcut',
    'DISPID_SRGState', 'SPPHRASERULE', 'DISPID_SpeechRecoContext',
    'SpSharedRecoContext', 'SPINTERFERENCE_NONE', 'SRAONone',
    'DISPID_SpeechGrammarRuleStateTransition',
    'ISpPhoneticAlphabetConverter', 'DISPID_SRIsShared',
    'SpeechCategoryAudioIn', 'eLEXTYPE_PRIVATE7',
    'SpNullPhoneConverter', 'SAFTADPCM_44kHzMono',
    'DISPID_SLGetPronunciations', 'SPSHT_OTHER',
    'DISPID_SRGSetWordSequenceData', 'DISPID_SRRTimes',
    'eLEXTYPE_PRIVATE5', 'SPCS_DISABLED', 'ISpRecoGrammar2',
    'DISPID_SPIElements', 'SAFT48kHz8BitStereo', 'SPLO_DYNAMIC',
    ...
    'DISPID_SGRs_NewEnum', 'SPEI_SR_AUDIO_LEVEL', 'DISPID_SLWWord',
    'SPSUnknown', 'DISPID_SLPLangId', 'SPAR_High', 'SPEVENT',
    'Speech_StreamPos_RealTime', 'SRSActiveAlways',
    'eLEXTYPE_RESERVED10', 'STCAll', 'DISPID_SPRules_NewEnum',
    'DISPID_SVEventInterests', 'SVEWordBoundary',
    'SSSPTRelativeToCurrentPosition', 'DISPID_SGRSTs_NewEnum',
    'SPSSuppressWord', 'SpLexicon', 'eLEXTYPE_RESERVED9',
    'SVEVoiceChange', 'SpObjectToken', 'SPAO_NONE', 'DISPID_SOTId',
    'DISPID_SPPChildren', 'SPEI_REQUEST_UI', 'SITooSlow',
    'SPSEMANTICERRORINFO', 'DISPID_SRGSetTextSelection',
    '_RemotableHandle', 'DISPID_SPAsItem', 'DISPIDSPTSI',
    'SECFNoSpecialChars', 'SpeechAudioFormatGUIDWave',
    'eLEXTYPE_PRIVATE16', 'SRSActive', 'DISPID_SRRSaveToMemory',
    'SAFT16kHz8BitMono', 'ISpeechPhoneConverter', 'SREPhraseStart',
    'SpeechRetainedAudioOptions', 'DISPID_SPIReplacements',
    'SP_VISEME_13', 'DISPID_SRSetPropertyString',
    'DISPID_SRCCreateGrammar', 'DISPID_SDKEnumKeys', 'ISpRecoGrammar',
    'SAFTCCITT_uLaw_44kHzMono', 'SREInterference', 'SPSFunction',
    'DISPID_SpeechAudioStatus', 'DISPID_SRStatus',
    'SGLexicalNoSpecialChars', 'DISPID_SRCPause', 'SVP_2',
    'DISPID_SRGCmdLoadFromMemory', 'DISPID_SDKSetLongValue',
    'SPRST_INACTIVE_WITH_PURGE', 'SpeechPropertyResponseSpeed',
    'WAVEFORMATEX', 'SPINTERFERENCE_NOISE', 'DISPID_SVRate',
    'DISPID_SRCRequestedUIType', 'eLEXTYPE_RESERVED4',
    'DISPID_SVSyncronousSpeakTimeout', 'SpeechWordType',
    'DISPID_SOTIsUISupported', 'SPSModifier', 'SPRST_ACTIVE_ALWAYS',
    'DISPID_SPPName', 'DISPID_SVSLastResult', 'SREAllEvents',
    'SpeechVoiceCategoryTTSRate', 'SVSFNLPMask', 'DISPID_SOTCDefault',
    'SVF_Emphasis', 'STCLocalServer', 'SECFDefault',
    'DISPID_SVSLastStreamNumberQueued', 'SpTextSelectionInformation',
    'SAFT12kHz16BitMono', 'SECFIgnoreKanaType', 'DISPID_SASState',
    'SRERecognition', 'DISPID_SPRsItem', 'ISpPhraseAlt',
    'DISPID_SPRuleParent', 'SAFT24kHz16BitMono',
    'DISPID_SVEAudioLevel', 'SPFM_CREATE_ALWAYS', 'SpMMAudioOut',
    'DISPID_SPPsItem', 'DISPID_SpeechPhraseAlternate',
    'SVSFVoiceMask', 'DISPID_SGRsCommit', 'DISPID_SPRs_NewEnum',
    'SVP_12', 'DISPID_SpeechDataKey', 'SRSEIsSpeaking',
    'SPINTERFERENCE_NOSIGNAL', 'DISPID_SRCState',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet', 'SGSEnabled',
    'eLEXTYPE_PRIVATE11', 'SpeechPropertyAdaptationOn',
    ...
    'ISpeechLexiconWord', 'SPPS_Modifier', 'ISpeechRecoResult2',
    'DISPID_SWFEExtraData', 'tagSPPROPERTYINFO', 'ISpRecognizer',
    'SAFTCCITT_uLaw_8kHzMono', 'SP_VISEME_0', 'SpCustomStream',
    'SECNormalConfidence', 'SPDKL_LocalMachine',
    'SpPhoneticAlphabetConverter', 'SpeechRuleAttributes',
    'DISPID_SVEViseme', 'Speech_Max_Pron_Length',
    'eLEXTYPE_RESERVED7', 'DISPID_SpeechRecognizerStatus',
    'DISPID_SLWs_NewEnum', 'SPEI_TTS_BOOKMARK',
    'SpeechTokenValueCLSID', 'SPBOOKMARKOPTIONS', 'DISPID_SBSWrite',
    'DISPID_SPEsItem', 'SPEI_TTS_PRIVATE', 'SpUnCompressedLexicon',
    'SPFM_OPEN_READONLY', 'DISPID_SMSAMMHandle', 'DISPIDSPRG',
    'SVEStartInputStream', 'SPWAVEFORMATTYPE', 'SPWORDTYPE',
    'SpeechCategoryVoices', 'SVP_15', 'SAFT24kHz8BitStereo',
    'DISPID_SLGetWords', 'DISPID_SRSAudioStatus', 'DISPID_SRCVoice',
    'SVSFParseAutodetect', 'SINoise',
    'ISpeechGrammarRuleStateTransition', 'DISPID_SGRSTsCount',
    'SRSEDone', 'DISPID_SRSSupportedLanguages', 'SPFM_CREATE',
    'SPRST_NUM_STATES', 'SASStop', 'SpeechDiscardType',
    'SPINTERFERENCE_LATENCY_TRUNCATE_END', 'ISpRecoContext',
    'SREAdaptation', 'SpeechGrammarWordType', 'SpAudioFormat',
    'DISPID_SLPSymbolic', 'DISPID_SOTCGetDataKey',
    'SAFTGSM610_44kHzMono', 'ISpRecognizer3', 'DISPID_SRSClsidEngine',
    'SpWaveFormatEx', 'SPPS_RESERVED2', 'DISPID_SGRsItem',
    'SpSharedRecognizer', 'ISpPhoneticAlphabetSelection',
    'DISPID_SRCEHypothesis', 'SDTPronunciation',
    'DISPID_SpeechLexiconWord', 'SpeechRecoContextState',
    'DISPID_SVSPhonemeId', 'DISPID_SpeechPhraseReplacements',
    'DISPID_SRIsUISupported', 'ISpObjectWithToken',
    'DISPID_SABufferNotifySize', 'SPDKL_DefaultLocation',
    'SP_VISEME_6', 'SAFTCCITT_uLaw_22kHzStereo', 'SVEViseme',
    'DISPID_SGRsAdd', 'eLEXTYPE_PRIVATE3', 'SINone',
    'STSF_FlagCreate', 'SPSMF_SAPI_PROPERTIES', 'SASClosed', 'SVP_19',
    'DISPID_SRRSpeakAudio', 'SVSFDefault', 'DISPID_SPCPhoneToId',
    'DISPID_SPRuleFirstElement', 'SpStream', 'DISPID_SFSOpen',
    'DISPID_SOTSetId', 'SVSFIsNotXML', 'DISPID_SPACommit',
    'DISPID_SRCEPropertyNumberChange', 'SDTRule', 'SRATopLevel',
    'SPAUDIOBUFFERINFO', 'SPLEXICONTYPE', 'DISPID_SVWaitUntilDone',
    'STSF_CommonAppData', 'DISPID_SRGetPropertyNumber',
    'DISPID_SGRsCommitAndSave', 'SPPS_Interjection',
    'DISPID_SRRTOffsetFromStart', 'ISpeechAudioBufferInfo',
    'SPSHORTCUTPAIRLIST', 'DISPID_SAEventHandle', 'SAFT24kHz8BitMono',
    'ISpeechRecoGrammar', 'eLEXTYPE_PRIVATE10', 'SGRSTTTextBuffer',
    'DISPID_SOTDisplayUI', 'SP_VISEME_15', 'SLOStatic', 'SPPS_Noun',
    'SpeechCategoryRecognizers', 'SAFTGSM610_8kHzMono',
    'SAFT11kHz8BitMono', 'DISPID_SRCRecognizer',
    'SpPhraseInfoBuilder', 'DISPID_SpeechPhraseBuilder',
    'DISPID_SGRsDynamic', 'SAFTText', 'SAFT11kHz8BitStereo',
    'SPEI_MAX_SR', 'SPPHRASEELEMENT', 'DISPID_SRRPhraseInfo', 'SVP_7',
    'SPWT_LEXICAL_NO_SPECIAL_CHARS',
    'DISPID_SpeechGrammarRuleStateTransitions', 'ISpeechMMSysAudio',
    'DISPID_SPIAudioSizeBytes', 'ISpeechRecognizer',
    'SAFT48kHz8BitMono', 'DISPID_SpeechGrammarRules',
    'DISPID_SRGetPropertyString', 'DISPID_SPARecoResult',
    'SVF_Stressed', 'SPRS_ACTIVE', 'SVESentenceBoundary',
    'DISPIDSPTSI_ActiveLength', 'SGRSTTRule',
    'SpeechCategoryPhoneConverters', 'SpeechCategoryRecoProfiles',
    'SPVPRIORITY', 'SpMMAudioEnum', 'DISPID_SPEAudioSizeTime',
    'SREBookmark', 'SVP_18', 'DISPID_SRRTLength',
    'SpeechTokenShellFolder', 'SpeechGrammarTagWildcard',
    'DISPID_SpeechPhraseProperty', 'eLEXTYPE_APP', 'SPAUDIOOPTIONS',
    'DISPID_SPANumberOfElementsInResult', 'SPEI_START_INPUT_STREAM',
    'tagSPTEXTSELECTIONINFO', 'SGSDisabled', 'SSFMOpenReadWrite',
    'DISPID_SVSInputSentencePosition', 'DISPID_SPEAudioStreamOffset',
    'DISPID_SDKEnumValues', 'SRTStandard', 'DISPID_SWFEFormatTag',
    'ISpNotifyTranslator', 'SP_VISEME_21', 'SPPS_Verb',
    'DISPID_SRCCreateResultFromMemory',
    'DISPID_SGRSAddRuleTransition', 'SPPS_Unknown', 'SPAS_CLOSED',
    'SREFalseRecognition', 'SSTTTextBuffer', 'SECLowConfidence',
    'SRTSMLTimeout', 'SPPS_Function', 'SPBO_PAUSE',
    'SPEI_START_SR_STREAM', 'SECHighConfidence', 'SECFIgnoreCase',
    ...
    'IInternetSecurityManager', 'SAFT8kHz8BitMono',
    'DISPID_SRCEPhraseStart', 'DISPID_SPERetainedSizeBytes',
    'DISPID_SOTs_NewEnum', 'DISPID_SLGenerationId', 'SPEI_VISEME',
    'SPWORDLIST', 'eLEXTYPE_VENDORLEXICON',
    'DISPID_SLGetGenerationChange', 'DISPID_SGRSTType',
    'SPVPRI_ALERT', 'DISPID_SpeechRecoResult2', 'SpFileStream',
    'SDA_One_Trailing_Space', 'SP_VISEME_1', 'DISPID_SRCEAudioLevel',
    'SpeechVoiceSpeakFlags', 'DISPID_SOTGetDescription',
    'DISPID_SRGCmdSetRuleState', 'DISPID_SVSInputWordPosition',
    'eLEXTYPE_PRIVATE2', 'SVP_3', 'ISpPhoneConverter',
    'Speech_Default_Weight', 'DISPID_SVStatus',
    'DISPID_SPPConfidence', 'SPEI_RECOGNITION', 'SPEI_RESERVED3',
    'SP_VISEME_7', 'SAFT32kHz8BitStereo', 'ISpeechRecoContext',
    'SpCompressedLexicon', 'DISPID_SASCurrentDevicePosition',
    'DISPID_SPRuleConfidence', 'SpeechStreamFileMode',
    'SPCATEGORYTYPE', 'DISPID_SRGDictationUnload', 'SREAudioLevel',
    'ISpeechObjectTokenCategory', 'SVSFUnusedFlags',
    'SAFTCCITT_uLaw_8kHzStereo', 'ISpRecoResult', 'SPEVENTSOURCEINFO',
    'DISPID_SpeechPhraseRules', 'SDKLCurrentConfig',
    'SAFTGSM610_22kHzMono', 'SAFTCCITT_uLaw_22kHzMono',
    'DISPID_SGRClear', 'SPEI_VOICE_CHANGE', 'SGDSActiveWithAutoPause',
    'DISPID_SpeechLexicon', 'SAFTADPCM_22kHzStereo',
    'SSFMOpenForRead', 'DISPID_SASetState', 'eLEXTYPE_MORPHOLOGY',
    'DISPID_SBSFormat', 'DISPID_SAFType', 'DISPID_SRState',
    'DISPID_SRGCmdLoadFromResource', 'DISPID_SPPEngineConfidence',
    'ISpeechVoiceStatus', 'DISPID_SPRFirstElement',
    'DISPID_SVAudioOutputStream', 'DISPID_SVSInputWordLength',
    'DISPID_SpeechPhraseRule', 'SPPHRASEPROPERTY', 'SDKLLocalMachine',
    'SpeechGrammarRuleStateTransitionType', 'DISPID_SPPValue',
    'DISPID_SPPsCount', 'DISPID_SVGetVoices',
    'DISPID_SRGDictationLoad', 'SpeechLoadOption', 'SPSHORTCUTPAIR',
    'SRSInactiveWithPurge', 'DISPID_SPCIdToPhone',
    'DISPID_SVAlertBoundary', 'SPEI_WORD_BOUNDARY',
    'ISpStreamFormatConverter', 'SPFM_OPEN_READWRITE',
    'DISPID_SRGCmdLoadFromProprietaryGrammar', 'SRCS_Disabled',
    'SpeechGrammarTagDictation', 'DISPID_SASCurrentSeekPosition',
    'SVEBookmark', 'SPSMF_SRGS_SEMANTICINTERPRETATION_MS',
    ...
    'ISpMMSysAudio', 'SpInProcRecoContext', 'SPSNoun', 'DISPID_SPPId',
    'SPDATAKEYLOCATION', 'DISPID_SDKDeleteValue', 'SASPause',
    'DISPID_SDKDeleteKey', 'DISPID_SPRText',
    'SpeechDictationTopicSpelling', 'SPWP_UNKNOWN_WORD_PRONOUNCEABLE',
    'SPPS_SuppressWord', 'SPGRAMMARSTATE',
    'DISPID_SRGCmdLoadFromFile', 'SFTSREngine', 'SpeechAudioVolume',
    'SVSFParseSsml', 'DISPID_SOTCId', 'SpeechAllElements',
    'DISPID_SAFGuid', 'SpeechTokenKeyAttributes',
    'eLEXTYPE_PRIVATE19', 'SLTUser', 'STSF_AppData',
    'DISPID_SRCEBookmark', 'SPDKL_CurrentUser', 'ISpeechAudioStatus',
    'SP_VISEME_16', 'SpeechEngineConfidence', 'ISpeechPhraseElements',
    'IEnumSpObjectTokens', 'SVPAlert', 'SVP_4', 'SPWORDPRONUNCIATION',
    'SpeechPropertyComplexResponseSpeed', 'SECFIgnoreWidth',
    'SGPronounciation', 'SAFTTrueSpeech_8kHz1BitMono',
    'SAFT22kHz16BitStereo', 'DISPID_SGRsCount',
    'DISPID_SLRemovePronunciationByPhoneIds', 'DISPID_SGRId',
    'ISpGrammarBuilder', 'eLEXTYPE_PRIVATE9', 'SPBINARYGRAMMAR',
    'DISPID_SAVolume', 'SAFTCCITT_ALaw_8kHzStereo',
    'DISPID_SOTGetStorageFileName', 'SPEI_INTERFERENCE',
    'DISPID_SAFSetWaveFormatEx',
    'DISPID_SRCERecognitionForOtherContext', 'SP_VISEME_4',
    'SP_VISEME_9', 'SPRST_ACTIVE', 'DISPID_SRCERecognizerStateChange',
    'SDA_No_Trailing_Space', 'SAFT22kHz8BitStereo',
    'SpNotifyTranslator', 'DISPID_SGRInitialState', 'DISPID_SFSClose',
    'SVP_9', 'SINoSignal', 'SITooFast', 'eLEXTYPE_PRIVATE6',
    'SAFTDefault', 'STCInprocServer', 'DISPID_SLWType',
    'SDTLexicalForm', 'DISPID_SLWPronunciations',
    'DISPID_SABIEventBias', 'DISPID_SRCEPropertyStringChange',
    'DISPID_SRGIsPronounceable', 'DISPID_SRCRetainedAudio',
    'DISPID_SpeechLexiconPronunciation', 'SVSFPurgeBeforeSpeak',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet',
    'SPGS_EXCLUSIVE', 'DISPID_SPPNumberOfElements',
    'DISPID_SRCERequestUI', 'ISpeechRecoResult', 'SAFT8kHz8BitStereo',
    'DISPID_SRGCmdLoadFromObject', 'SpeechUserTraining',
    'DISPID_SpeechRecoResult', 'SRESoundEnd',
    'DISPID_SOTCEnumerateTokens', 'eLEXTYPE_USER_SHORTCUT',
    'SDA_Two_Trailing_Spaces', 'DISPID_SGRSTNextState', 'SPRULE',
    'DISPID_SpeechMemoryStream', 'SVSFIsFilename', 'DISPID_SOTRemove',
    'SSFMCreateForWrite', 'SRTExtendableParse', 'SITooQuiet',
    'DISPID_SPIRetainedSizeBytes', 'DISPID_SpeechPhraseProperties',
    'ISpeechLexiconPronunciations', 'DISPID_SPAs_NewEnum',
    'SVSFIsXML', 'DISPID_SVAudioOutput', 'SPWT_LEXICAL',
    'SPAO_RETAIN_AUDIO', 'SAFTNoAssignedFormat', 'SP_VISEME_14',
    'DISPID_SADefaultFormat', 'SPEI_FALSE_RECOGNITION',
    'ISpeechObjectTokens', 'ISpeechPhraseProperties',
    'DISPID_SVSpeak', 'SVEAllEvents', 'SGRSTTDictation',
    'DISPID_SREmulateRecognition', 'SDTDisplayText',
    'SPSHT_NotOverriden', 'SRAImport', 'SPRS_ACTIVE_USER_DELIMITED',
    'ISpeechResourceLoader', 'DISPID_SRRRecoContext', 'SPVOICESTATUS',
    'SPEI_MIN_TTS', 'SPCS_ENABLED', 'DISPID_SpeechRecoResultTimes',
    'SAFT24kHz16BitStereo', 'SRERecoOtherContext',
    'SAFTCCITT_uLaw_11kHzStereo', 'DISPID_SMSSetData', 'SGDisplay',
    'ISpeechRecognizerStatus', 'SPWT_PRONUNCIATION', 'SPFILEMODE',
    'SPSHT_EMAIL', 'SpStreamFormatConverter', 'SpeechVisemeFeature',
    'DISPID_SDKCreateKey', 'SRTReSent', 'SP_VISEME_12',
    'SPPROPERTYINFO', 'SPEI_SOUND_START',
    '__MIDL___MIDL_itf_sapi_0000_0020_0002', 'eLEXTYPE_PRIVATE1',
    'SPRECOGNIZERSTATUS', 'eLEXTYPE_RESERVED8',
    'DISPID_SPIEnginePrivateData', 'DISPID_SpeechMMSysAudio',
    'DISPID_SGRName', 'ISpeechPhraseAlternates', 'SBOPause',
    'DISPID_SRCreateRecoContext', 'SPXRO_SML',
    'DISPID_SpeechAudioBufferInfo', 'SPAUDIOSTATE', 'DISPID_SAStatus',
    'eWORDTYPE_ADDED', 'DISPID_SPEPronunciation', 'SREHypothesis',
    'SDKLCurrentUser', 'SDTProperty',
    'DISPID_SpeechObjectTokenCategory', 'SPPHRASE',
    'ISpeechPhraseReplacement', 'DISPID_SRCSetAdaptationData',
    'SpeechSpecialTransitionType', 'SpeechVisemeType', 'UINT_PTR',
    'SpeechCategoryAppLexicons', 'DISPID_SLWsCount',
    'DISPID_SDKGetBinaryValue', 'ISpAudio', 'SVEPrivate',
    'DISPID_SPEs_NewEnum', '_SPAUDIOSTATE',
    'DISPID_SPEAudioSizeBytes', 'SAFT44kHz8BitStereo',
    'DISPIDSPTSI_ActiveOffset', 'ISpeechDataKey',
    'DISPID_SPIGetDisplayAttributes', 'ISpeechAudioFormat',
    'SPSTREAMFORMATTYPE', 'ISpeechAudio', 'ISpeechGrammarRule',
    'DISPID_SOTDataKey', 'DISPID_SWFESamplesPerSec',
    'SpeechEngineProperties', 'DISPID_SPIEngineId',
    'DISPID_SVGetAudioOutputs', 'DISPIDSPTSI_SelectionOffset',
    'STCRemoteServer', 'DISPID_SVEEnginePrivate',
    'DISPID_SOTCreateInstance', 'ISequentialStream',
    'DISPID_SRRAudioFormat', 'SPINTERFERENCE_LATENCY_WARNING',
    'SAFTCCITT_uLaw_44kHzStereo', 'DISPID_SRCEFalseRecognition',
    'DISPID_SGRSTText', 'SVSFPersistXML', 'DISPID_SGRSTPropertyName',
    'SPCT_COMMAND', 'SPRECOSTATE', 'ISpeechPhraseAlternate',
    'SPVPRI_NORMAL', 'ISpObjectTokenCategory', 'SAFT32kHz16BitMono',
    'DISPID_SpeechRecognizer', 'SpeechTokenKeyFiles', 'SPEI_MIN_SR',
    'DISPID_SPIAudioStreamPosition', 'SpeechPropertyResourceUsage',
    'SAFT32kHz16BitStereo', 'DISPID_SLPsItem', 'SRSInactive',
    'SPEI_END_SR_STREAM', 'ISpStream', 'SGRSTTWord', 'ISpeechVoice',
    'ISpeechTextSelectionInformation', 'DISPID_SOTsItem', 'SDTAll',
    'SREPropertyNumChange', 'SRAExport',
    'DISPID_SPERequiredConfidence', 'DISPID_SLAddPronunciation',
    'SPGS_ENABLED', 'eLEXTYPE_PRIVATE13', 'SPSNotOverriden',
    'DISPID_SVEBookmark', 'SPINTERFERENCE_TOOLOUD',
    'SpeechRecoEvents', 'SP_VISEME_2', 'SBONone',
    'SpeechDataKeyLocation', 'SPEI_RESERVED2', 'DISPID_SPEsCount',
    'SpeechRunState', 'DISPID_SLWsItem',
    'DISPID_SRSCurrentStreamPosition', 'SPRULESTATE',
    'SPSMF_SRGS_SAPIPROPERTIES', 'ISpObjectToken', 'SVP_5',
    'eLEXTYPE_RESERVED6', 'DISPID_SVESentenceBoundary',
    'SPEI_UNDEFINED', 'DISPID_SRGetRecognizers', 'SPEI_ADAPTATION',
    'DISPID_SLPs_NewEnum', 'SVP_0', 'ISpeechGrammarRules',
    'DISPID_SpeechPhoneConverter', 'DISPID_SpeechFileStream',
    'SDTAlternates', 'SP_VISEME_19', 'DISPID_SLPPartOfSpeech',
    'DISPID_SRCEEndStream', 'SPPS_RESERVED4', 'DISPID_SVPause',
    'SPSERIALIZEDPHRASE', 'SAFTADPCM_11kHzStereo',
    'DISPID_SWFEAvgBytesPerSec', 'DISPID_SRCEAdaptation',
    'SpObjectTokenCategory', 'DISPID_SLPType', 'SVP_20',
    'DISPID_SCSBaseStream', 'SAFT12kHz8BitStereo',
    'DISPID_SVSpeakStream', 'SPINTERFERENCE_TOOQUIET',
    'SPWF_SRENGINE', 'SVSFNLPSpeakPunc',
    'SWPUnknownWordPronounceable', 'SpeechGrammarState',
    'SpeechPartOfSpeech', 'eLEXTYPE_PRIVATE4', 'SPEI_RESERVED5',
    'DISPID_SPRuleNumberOfElements', 'SRADynamic',
    'DISPID_SPRDisplayAttributes', 'DISPID_SOTCSetId',
    'DISPID_SPPBRestorePhraseFromMemory', 'DISPID_SLPsCount',
    'SRCS_Enabled', 'SPSEMANTICFORMAT', 'SP_VISEME_20',
    'DISPID_SGRSTWeight', 'SGRSTTWildcard',
    'DISPID_SpeechLexiconWords', 'SpMemoryStream',
    'SpeechStreamSeekPositionType', 'SGLexical', 'DISPID_SLPPhoneIds',
    'SPEI_SENTENCE_BOUNDARY', 'DISPID_SpeechAudio',
    'ISpeechLexiconWords', 'DISPID_SpeechBaseStream',
    'DISPID_SASFreeBufferSpace', 'SFTInput', 'SPWT_DISPLAY',
    'SPEI_ACTIVE_CATEGORY_CHANGED', 'SpVoice', 'SPEI_SOUND_END',
    'SAFT44kHz8BitMono', 'SPEI_SR_PRIVATE', 'SPPS_RESERVED3',
    'ISpXMLRecoResult', 'DISPID_SGRAttributes', 'SVP_14',
    'DISPID_SMSADeviceId', 'DISPID_SPIProperties',
    'DISPID_SRSNumberOfActiveRules', 'DISPID_SPRulesItem',
    'SAFT44kHz16BitStereo', 'SP_VISEME_10', 'ISpEventSource',
    'SDTAudio', 'SPRS_ACTIVE_WITH_AUTO_PAUSE',
    'SREPropertyStringChange', 'DISPID_SRAudioInputStream',
    'DISPID_SPEEngineConfidence', 'DISPID_SRGetFormat', 'SGDSActive',
    'DISPID_SDKOpenKey', 'SAFT11kHz16BitMono',
    'DISPID_SRRSetTextFeedback', 'ISpeechMemoryStream',
    'SPDKL_CurrentConfig', 'SpInprocRecognizer',
    'SPTEXTSELECTIONINFO', 'DISPID_SPPs_NewEnum',
    'SPEI_SR_RETAINEDAUDIO', 'DISPID_SRRGetXMLErrorInfo', 'SASRun',
    'ISpRecognizer2', 'SpeechBookmarkOptions',
    'DISPID_SPERetainedStreamOffset', 'SPPARTOFSPEECH',
    'DISPID_SMSGetData', 'SLODynamic', 'DISPID_SPIStartTime',
    'DISPID_SWFEChannels', '_ISpeechVoiceEvents',
    'SAFT16kHz16BitMono', 'Speech_StreamPos_Asap',
    'SPSERIALIZEDRESULT', 'DISPID_SRRecognizer', 'SRAORetainAudio',
    'eLEXTYPE_USER', 'SRADefaultToActive', 'SpeechRegistryUserRoot',
    'SRTAutopause', 'SLTApp', 'SGDSActiveUserDelimited',
    'SPRS_INACTIVE', 'DISPID_SDKGetlongValue', 'SPEI_RESERVED6',
    'DISPID_SpeechGrammarRule', 'SPFM_NUM_MODES', 'DISPID_SBSSeek',
    'DISPID_SRCBookmark', 'DISPID_SRCEventInterests',
    'SWPUnknownWordUnpronounceable', 'IStream', 'SPCONTEXTSTATE',
    'SPSVerb', 'SSSPTRelativeToEnd', 'DISPID_SPELexicalForm',
    'eLEXTYPE_PRIVATE15', 'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE',
    'DISPID_SpeechXMLRecoResult', 'DISPID_SRSetPropertyNumber',
    'tagSTATSTG', 'SPWORD', 'SAFTCCITT_ALaw_22kHzStereo',
    'DISPID_SVIsUISupported', 'SVP_6', 'ISpeechFileStream',
    'DISPID_SpeechVoiceEvent', 'ISpeechGrammarRuleStateTransitions',
    'DISPID_SVEStreamEnd', 'ISpeechBaseStream',
    'SpeechAudioFormatGUIDText', 'DISPID_SpeechWaveFormatEx',
    'SpeechVoiceEvents', 'ISpStreamFormat', 'SpeechRuleState',
    'SAFTGSM610_11kHzMono', 'SpeechEmulationCompareFlags',
    'DISPID_SRGReset', 'DISPID_SRRAudio', 'SAFTADPCM_22kHzMono',
    'SpeechDisplayAttributes', 'eLEXTYPE_PRIVATE18',
    'DISPID_SMSALineId', 'ISpSerializeState',
    'SAFTCCITT_ALaw_44kHzMono', 'ISpeechLexicon', 'SpPhoneConverter',
    'SPLO_STATIC', 'SPEI_HYPOTHESIS', 'DISPID_SpeechVoiceStatus',
    'SpeechAudioState', 'SP_VISEME_3', 'DISPID_SPRNumberOfElements',
    'IEnumString', 'SPWP_KNOWN_WORD_PRONOUNCEABLE',
    'SAFTCCITT_ALaw_22kHzMono', 'SPAUDIOSTATUS', 'DISPID_SRCResume',
    'DISPID_SGRsFindRule', 'ISpRecoCategory',
    'DISPID_SpeechLexiconProns', 'DISPID_SVSkip',
    'SpeechCategoryAudioOut', 'SPSHORTCUTTYPE',
    'SpeechWordPronounceable'
]

_check_version('1.2.0', 1625944315.691988)
